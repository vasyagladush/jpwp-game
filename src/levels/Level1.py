...
from actors.actor1.Actor1 import Actor1

from enum import Enum

from levels.Tilemap1 import Tilemap1
...
class Level1(Level):
    def __init__(self) -> None:
        super().__init__(
            actors=Tilemap1().actors + [Actor1(Vector(100, 100), RenderingOrder.BACKGROUND.value, AnimationPlayMode.STATIC_IMAGE),
                                        Actor1(
